...
abstract class AbstractThemeColors {
  ...
  Color get buttonBackground => const Color.fromARGB(255, 48, 48, 24);

  Color get roundedBackground => const Color.fromARGB(255, 24, 24, 24);

  Color get unreadColor => const Color.fromARGB(255, 48, 48, 24);
